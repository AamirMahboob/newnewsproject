      ...
      {isOpen && (
        <div className="md:hidden bg-yellow-50 border-t">
          <ul className="flex flex-col space-y-2 px-6 py-4">
            <li className="text-gray-700 hover:text-yellow-500 cursor-pointer">Home</li>
            <li className="text-gray-700 hover:text-yellow-500 cursor-pointer">About</li>
            <li className="text-gray-700 hover:text-yellow-500 cursor-pointer">Contact</li>
          </ul>
        </div>
      )}
    </nav>
